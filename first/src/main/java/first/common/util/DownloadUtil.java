...
public class DownloadUtil {
  ...
  public static void download(HttpServletRequest request, HttpServletResponse response, File file, String fileName)
    ...
    try {
      ...
      download(request, response, is, file.getName(), file.length(), mimetype, fileName);
    } finally {
      try {
        is.close();
      } catch (Exception ex) {
  ...
  public static void download(HttpServletRequest request, HttpServletResponse response, InputStream is,
    String filename, long filesize, String mimetype, String fileName) throws ServletException, IOException {
