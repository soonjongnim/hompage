...
<!--   </div> -->
  ...
  <div >
    ...
    <div class="w3-display-container mySlides">
      <img src="${pageContext.request.contextPath}/images/Template_general/field.jpg" style="width:100%">
      <div class="w3-display-topleft w3-container ">
          <%@ include file="header.jsp"%> 
      </div>
    </div>    
    <div class="w3-display-container mySlides">
      <img src="${pageContext.request.contextPath}/images/Template_general/workbench.jpg" style="width:100%">
      <div class="w3-display-topleft w3-container ">
          <%@ include file="header.jsp"%> 
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="${pageContext.request.contextPath}/images/Template_general/sound.jpg" style="width:100%">
      <div class="w3-display-topleft w3-container ">
          <%@ include file="header.jsp"%> 
      </div>
    </div>
