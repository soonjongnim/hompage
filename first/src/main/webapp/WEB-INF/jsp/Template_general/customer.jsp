		  ...
		  <div class="w3-center" style="padding: 0px 30px;">
					  ...
					  <div id="Introduction" class="w3-container w3-border-white fr-content">
						  ...
						  <div class="w3-row-padding w3-padding-small w3-center" >
						    ...
						    <img src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/Template_general/machine.jpg"  alt="Me" class="w3-image" style="display:block;margin:auto" width="100%" >
